...
if(isset($_POST['action'])){
    $db = mysqli_connect("192.168.133.131", "root", "achilles", "webdata")
        ...
        while($row=mysqli_fetch_array($result)){
            $output .= '
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" name="update" class="btn btn-warning bt-xs update" id="'.$row['id'].'">
                        Change</button>
                    </td>
                    <td>
                        <button type="button" name="delete" class="btn btn-danger bt-xs delete" id="'.$row['id'].'">
                        Remove</button>
                    </td>
                </tr>
            ';
